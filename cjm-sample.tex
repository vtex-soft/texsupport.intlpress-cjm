...
\received{\smonth{12} \sday{7}, \syear{2012}}
...
\hline
Points & \multicolumn{1}{c}{$x$} & \multicolumn{1}{c}{$y$} & \multicolumn{1}{c}{$z$} & \multicolumn{1}{c}{$C$} &S \\
\hline
...
Already in the early publications \cite{1,2,3}
...
\cite{1}  and of \cite{4} which were obtained for
...
the value $K_{M}=1$ g/L as used by \cite{1}, one finds
with the above equation $0.3 < C_{s} < 9$ g/L. This agrees well with
the work of  \cite{4}, who reported that penicillin biosynthesis
